      ...
      <div className="grid grid-cols-1 sm:grid-cols-12 gap-2.5">
        ...
        <div className="sm:col-span-6 grid grid-cols-2 gap-2 sm:gap-2.5">
          ...
          <div
            ...
            className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-[#0088cc] via-[#0077b5] to-[#005f99] p-3 text-white shadow-xs flex flex-col justify-between h-[115px] border border-blue-400/30 cursor-pointer active:scale-95 transition-all duration-300 ease-out hover:shadow-md group text-left"
          >
